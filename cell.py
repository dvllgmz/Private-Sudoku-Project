...
class Cell:
    ...
    def set_sketched_value(self, value):
        self.sketched_value = str(value)  # converts to string, useful to display if it is an int
        self.is_sketch = True
        self.is_given = False
    ...
    def draw(self, is_selected=False):
        ...
        cell_value = self.value if not self.is_sketch else self.sketched_value  # prints sketch value if it's a sketch
